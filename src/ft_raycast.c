...
/*   Updated: 2017/02/18 19:35:19 by vrybalko         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void		ft_raycast(t_e *e)
{
	...
	while (++i < e->width)
	{
		...
		ft_draw_line(e, point_in(i, 0), point_in(i, ray.d_start),
				0x33);
		ft_draw_line(e, point_in(i, ray.d_start), point_in(i, ray.d_end),
				ray.color);
		ft_draw_line(e, point_in(i, ray.d_end), point_in(i, e->height - 1),
				0x777777);
	}
}
